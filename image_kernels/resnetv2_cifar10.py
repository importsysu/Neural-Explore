...
tf.app.flags.DEFINE_string('save_path', './log/resnetv2_cifar10', 'Model parameter save path')
...
def build_train_op(image_tensor, label_tensor, is_training):
    ...
    with slim.arg_scope(resnet_argscope):
        logits, end_points = resnet_v2_50(image_tensor, is_training=is_training, num_classes=10)
