...
tf.app.flags.DEFINE_string('save_path', './log/vgg11_cifar100', 'Model parameter save path')
...
def build_train_op(image_tensor, label_tensor, is_training):
    ...
    with slim.arg_scope(vgg_argscope):
        logits, end_points = vgg_11(image_tensor, is_training=is_training, num_classes=100)
